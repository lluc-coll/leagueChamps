package com.example.leaguechamps.dataclass
...
data class ItemAPI(
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<ItemAPI> = object : Parcelable.Creator<ItemAPI> {
            override fun createFromParcel(source: Parcel): ItemAPI = ItemAPI(source)
            override fun newArray(size: Int): Array<ItemAPI?> = arrayOfNulls(size)
        }
    }
}
